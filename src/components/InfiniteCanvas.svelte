<script lang="ts">
    ...
    const cardDefinitions = [
            ...
            images: [
                {
                    cols: 3,
                    images: [
                        { src: "/assets/images/eindhoven/Mod8-3.png", alt: "Data Physicalization Project" },
                        { src: "/assets/images/eindhoven/Mod8.png", alt: "Data Physicalization Project" },
                        { src: "/assets/images/eindhoven/Mod8-2.png", alt: "Data Physicalization Project" }
                    ],
                ...
                },
                {
                    cols: 2,
                    images: [
                        { src: "/assets/images/eindhoven/spotty-1.png", alt: "Low poly video game" },
                        { src: "/assets/images/eindhoven/spotty-2.png", alt: "Low poly video game" }
                    ],
                ...
                },
                {
                    cols: 3,
                    images: [
                        { src: "/assets/images/eindhoven/stand1.jpg", alt: "Startup booth" },
                ...
                },
                {
                    cols: 3,
                    images: [
                        { src: "/assets/images/eindhoven/lms-1.png", alt: "Information system" },
                        { src: "/assets/images/eindhoven/lms-2.png", alt: "Information system" },
                        { src: "/assets/images/eindhoven/lms-3.png", alt: "Information system" }
                    ],
        ...
        },
        {
            id: "vision",
            title: "Vision",
            x: () => cardDefinitions.find(c => c.id === "professional-identity")!.x as number + 1300,
            y: () => cardDefinitions.find(c => c.id === "professional-identity")!.y as number,
            width: 1200,
            content:
        ...
        },
        {
            ...
            x: () => cardDefinitions.find(c => c.id === "future-development")!.x as number + 1300,
            y: () => cardDefinitions.find(c => c.id === "future-development")!.y as number,
            width: 1200,
            content:
        ...
        },
        {
            ...
            x: () => cardDefinitions.find(c => c.id === "future-development")!.x as number - 1300,
            y: () => cardDefinitions.find(c => c.id === "future-development")!.y as number + 500,
            width: 1200,
            content:
        ...
        },
        {
            id: "long-term",
            title: "Long Term",
            x: () => cardDefinitions.find(c => c.id === "future-development")!.x as number,
            y: () => cardDefinitions.find(c => c.id === "future-development")!.y as number + 500,
            width: 1200,
            content:
        ...
        },
        {
            ...
            x: () => cardDefinitions.find(c => c.id === "future-development")!.x as number,
            y: () => cardDefinitions.find(c => c.id === "future-development")!.y as number + 900,
            width: 1200,
            content:
        ...
        },
        {
            ...
            x: () => cardDefinitions.find(c => c.id === "future-development")!.x as number,
            y: () => cardDefinitions.find(c => c.id === "future-development")!.y as number + 1300,
            width: 1200,
            content:
    ...
    const connections = [
        ...
        // Courses Year 2 → Beyond Education (horizontal)
        { 
            from: "courses-year-2", 
        ...
        // Professional Identity → Specialization Track (cross connection)
        { 
    ...
    function getCardEdgePoint(
        ...
        // Estimate card height based on content length (rough approximation)
        // Average: 600 chars per 100px height for 600px width cards
        const estimatedHeight = Math.max(200, Math.ceil(card.content.length / 6) + 100);
        ...
        switch (side) {
            ...
            case "right":
                return { x: card.x + card.width, y: card.y + estimatedHeight / 2 };
        }
    }

    function getArrowPoints(connection: typeof connections[0]): Array<{ x: number; y: number }> {
    ...
    function animateToTarget() {
        ...
        if (Math.abs(panXDiff) < threshold && Math.abs(panYDiff) < threshold && Math.abs(zoomDiff) < 0.01) {
            // Animation complete
            panX = targetPanX;
            panY = targetPanY;
            zoom = targetZoom;
    ...
    onMount(() => {
        ...
        if (isPreview && canvasElement) {
            const rect = canvasElement.getBoundingClientRect();
            const professionalIdentityCard = cards.find(c => c.id === "professional-identity");
...
<div class="canvas-wrapper" class:fullscreen={isFullscreen}>
    ...
    >
        <!-- Dot grid background -->
        <div class="dot-grid" style="transform: translate({panX}px, {panY}px) scale({zoom})"></div>

        <!-- Canvas content with transformation -->
        <div class="canvas-content" style="transform: translate({panX}px, {panY}px) scale({zoom})">
        ...
        {#if isPreview && !isFullscreen}
            <button class="canvas-action-button enlarge" on:click={toggleFullscreen} type="button">
                <Maximize2 size={16} />
                Enlarge
            </button>
        {/if}
        ...
        {#if isFullscreen}
            <button class="canvas-action-button close" on:click={toggleFullscreen} type="button">
                <X size={20} />
            </button>
        {/if}
...
<style>
    ...
    .canvas-wrapper.fullscreen {
        ...
        z-index: 1000;
        margin: 0;
        background: var(--background-color);  /* Solid background to hide page content */
    }
